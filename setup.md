...
Download NLTK data (can we move this container .def file?)
```
python3 -c "import nltk; nltk.download('wordnet2022')"
```
This will download the dataset inside `~/nltk_data/corpora/wordnet2022` which needs to be renamed
```
mv ~/nltk_data/corpora/wordnet2022 ~/nltk_data/corpora/wordnet
```
